...
try:
    ...
    original_data = pd.read_csv("word_en_it.csv")
...
def flip_card():
    canvas.itemconfig(card_title, text="Italian", fill="white")
    canvas.itemconfig(card_word, text=current_card["Italian"], fill="white")
...
window = Tk()
window.title("Flash Card Eng to Ita")
...
#card_back_background = canvas.create_image(400, 263, image=card_back_img)
card_title = canvas.create_text(400, 150, text="", font=("Arial", 40, "italic"))
card_word = canvas.create_text(400, 300, text="", font=("Arial", 80, "bold"))
