...
class poseDetector():
    ...
    def __init___(self, mode = False, upBody = False, smooth = True, detectionCon = 0.5,
                  trackCon = 0.5):
    ...
    def findAngle(self, img, p1, p2, p3, draw = True):
        ...
        if draw:
            ...
            cv2.putTexr(img, str(int(angle)), (x2-50, y2+50), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 255), 2)
...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            print (lmList[14]) #numero del marker che deve essere salvato. se non metto numero = tutti
